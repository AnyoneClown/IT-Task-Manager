...
from .views import index, TaskListView, WorkerListView, TaskDetailView, WorkerDetailView, WorkerUpdateView, WorkerDeleteView, TaskCreateView, MyCompletedTaskListView, MyInProgressTaskListView, complete_task, TaskTypeListView, TaskTypeUpdateView, TaskTypeCreateView, TaskTypeDeleteView, PositionListView, PositionDeleteView, PositionUpdateView, PositionCreateView
